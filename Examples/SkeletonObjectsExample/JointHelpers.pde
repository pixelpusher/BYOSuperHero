// this is dumb...  should be enumerating OpenNI capabilities
// TODO: figure out how to do that using SimpleOpenNI wrapper!
// by Evan

import java.util.Map.Entry;

HashMap<Integer, String>  JOINT_NAMES;
HashMap<Integer, String> jointIDs;
