...
String armTexFile  = "arm2.png";
String legTexFile  = "leg2.png";


PImage bodyTex2, headTex2, armTex2, legTex2;

String bodyTexFile2 = "torsonew.png";
String headTexFile2 = "head2.png";
String armTexFile2  = " arm2new.png";
String legTexFile2  = "leg2new.png";
...
// this next bit of code disables "screen tearing"
  ...
  fireballTex = new GLTexture(this, "webball.png");
  fireballTex2 = new GLTexture(this, "webball2.png");
  ...
  legTex = loadImage(legTexFile);
   ...
   bodyTex2 = loadImage(bodyTexFile2);
  headTex2 = loadImage(headTexFile2);
  armTex2 = loadImage(armTexFile2);
  legTex2 = loadImage(legTexFile2);
...
//THIS IS THE SECTION TO DEFINE THE MOVEMENT OF SKELETON & FIREBALL----------------------
...

{
    ...
    else
    {
      ...
      {
        // hand is pretty much horizontal - shoot some fireballs!
        newSwarm( fireballTex2, skel.rightHandPos, handElbowDir ); 
      }
      // these draw based on pixels
      renderRectFromVectors(skel.leftShoulderPos, skel.rightShoulderPos, skel.rightHipPos, skel.leftHipPos, 5, 10, bodyTex2);

      renderRectFromVectors(skel.leftShoulderPos, skel.leftHandPos, 25, armTex2);      
      renderRectFromVectors(skel.rightShoulderPos, skel.rightHandPos, 25, armTex2, 1);

      renderRectFromVectors(skel.facePos, skel.neckPos, 40, 0, headTex2);

      renderRectFromVectors(skel.leftHipPos, skel.leftFootPos, 30, legTex2);      
      renderRectFromVectors(skel.rightHipPos, skel.rightFootPos, 30, legTex2, 1);
